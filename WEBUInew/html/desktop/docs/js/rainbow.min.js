$(function(){
    ...
    $(".btn-clipboard").append('<i class="tuopen"></i>');
    //默认隐藏代码区域
    $(".highlight").hide();//开始代码区是隐藏的
    $(".demo_content").find(".btn-clipboard:first").click(function(){
        if($(this).next().next(".highlight").is(":hidden")){
            ...
            $(this).text("隐藏代码");
            $(this).append('<i class="tuclose"></i>');
        }else{
            $(this).next().next(".highlight").slideUp();
            $(this).text("显示源码");
            $(this).next(".tuclose").removeClass("tuclose");
            $(this).append('<i class="tuopen"></i>');
        }
    });
