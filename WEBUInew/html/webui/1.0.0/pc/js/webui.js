...
if(r1||r2){
$(this).addClass("webui-fluid");
}else{
$(this).removeClass("webui-fluid");
}
});
}
...
if($(this).hasClass("webui-fluid")||_9e){
_84(this);
}
return false;
});
...
},beforePageText:"第",afterPageText:"页，共{pages}页",displayMsg:"{from}-{to} 条，总 {total} 条",nav:{first:{iconCls:"pagination-first",handler:function(){
...
if(_ec.id==undefined){
_ec.id="webui_tree_node_id_temp";
_127(_e6,_ec);
}
...
if(_ed&&_ed.id=="webui_tree_node_id_temp"){
_ed.id="";
_127(_e6,_ed);
}
...
if($(this).hasClass("webui-fluid")||_1dd){
_1de(_1dc);
}
return false;
});
...
case "right":
left+=t._outerWidth()+6+(opts.trackMouse?12:0);
top-=(tip._outerHeight()-t._outerHeight())/2;
break;
case "left":
left-=tip._outerWidth()+6+(opts.trackMouse?12:0);
top-=(tip._outerHeight()-t._outerHeight())/2;
break;
case "top":
left-=(tip._outerWidth()-t._outerWidth())/2;
top-=tip._outerHeight()+6+(opts.trackMouse?12:0);
break;
case "bottom":
left-=(tip._outerWidth()-t._outerWidth())/2;
top+=t._outerHeight()+6+(opts.trackMouse?12:0);
break;
}
...
_1fa.add(_1fb).css({borderTopColor:"",borderBottomColor:"",borderLeftColor:"",borderRightColor:"",opacity:""});
...
if(typeof cc == "object"){_201.tip.addClass("tooltip-obj");}
...
if($(this).hasClass("webui-fluid")||_21c){
_20c(_21a);
}
return false;
});
...
if(_255.length){
_255.layout("resize");
$("body").children(".webui-fluid:visible").each(function(){
...
var s=$(_260).find("div.panel:visible,div.accordion:visible,div.tabs-container:visible,div.layout:visible,.webui-fluid:visible").filter(function(_262,el){
...
var _295=$("<a class='btn-grey' href=\"javascript:void(0)\"></a>").appendTo(_294);
}else{
var _295=$("<a class='btn-blue' href=\"javascript:void(0)\"></a>").appendTo(_294);
}
if(p.handler){
...
bb.insertAfter(_298).css({position:"relative",top:0});
tb.add(bb)._outerWidth(t._outerWidth()).find(".webui-fluid:visible").each(function(){
$(this).triggerHandler("_resize");
});
if(!isNaN(parseInt(opts.height))){
...
$("<a href=\"javascript:void(0)\" style=\"margin-left:10px\"></a>").appendTo(tb).linkbutton(btn).addClass("btn-blue");
});
}
win.window("window").addClass("messager-window");
win.window("resize");
win.children("div.messager-button").children("a:first").focus();
if(_2aa.buttons.length>1){
win.children("div.messager-button").children("a:last").addClass("btn-grey");
}
return win;
};
...
var win=_2a9(opts);
return win;
},confirm:function(_2ad,msg,fn,arr){
if(arr==null || arr==''||arr.length<=0 || arr == 'undefined' ){
var _arr = [];
_arr.push($.messager.defaults.ok); 
_arr.push($.messager.defaults.cancel); 
arr = _arr;
}
var opts=typeof _2ad=="object"?_2ad:{title:_2ad,msg:msg,fn:fn};
opts=$.extend({},$.messager.defaults,{content:"<div class=\"messager-icon messager-question\"></div>"+"<div>"+opts.msg+"</div>"+"<div style=\"clear:both;\"/>",buttons:[{text:arr[0],onClick:function(){
win.window("close");
opts.fn(true);
}},{text:arr[1],onClick:function(){
win.window("close");
opts.fn(false);
}}]},opts);
var win=_2a9(opts);
...
if($(this).hasClass("webui-fluid")||_2d3){
_2b2(_2d1);
}
return false;
});
...
ul._outerHeight(ul.outerHeight()-ul.height()-1+opts.tabHeight-1).css("width","");
...
p_t.find(".webui-fluid:visible").triggerHandler("_resize");
};
};
function _325(_326){
...
cc.children("div.tabs-header").find(".tabs-scroller-left").hover(function(){
$(this).addClass("tabs-scroller-left-over");
},function(){
$(this).removeClass("tabs-scroller-left-over");
});
cc.children("div.tabs-header").find(".tabs-scroller-right").hover(function(){
$(this).addClass("tabs-scroller-right-over");
},function(){
$(this).removeClass("tabs-scroller-right-over");
});
cc.children("div.tabs-header").find(".tabs-scroller-left").mousedown(function(){
$(this).addClass("tabs-scroller-left-press");
});
cc.children("div.tabs-header").find(".tabs-scroller-right").mousedown(function(){
$(this).addClass("tabs-scroller-right-press");
});
cc.children("div.tabs-header").find(".tabs-scroller-left").mouseup(function(){
$(this).removeClass("tabs-scroller-left-press");
});
cc.children("div.tabs-header").find(".tabs-scroller-right").mouseup(function(){
$(this).removeClass("tabs-scroller-right-press");
});
cc.bind("_resize",function(e,_32e){
if($(this).hasClass("webui-fluid")||_32e){
_319(_32c);
_325(_32c);
}
return false;
...
/*添加自定义class*/
tabs.addClass(opts.className?"tabs-"+opts.className:"");
...
//改变tabs图标与文本的结构
var tab=$("<li>"+"<a href=\"javascript:void(0)\" class=\"tabs-inner\">"+"<span class=\"tabs-icon\"></span>"+"<span class=\"tabs-title\"></span>"+"</a>"+"</li>");
if(!pp){
pp=$("<div></div>");
}
...
if (pos == _381()) {
	$(this).find(">div.tabs-header>.tabs-scroller-right").addClass("tabs-scroller-right-unpress");
}else {
	$(this).find(">div.tabs-header>.tabs-scroller-right").removeClass("tabs-scroller-right-unpress");
}
if (pos <= 0) {
	$(this).find(">div.tabs-header>.tabs-scroller-left").addClass("tabs-scroller-left-unpress");
}else {
	$(this).find(">div.tabs-header>.tabs-scroller-left").removeClass("tabs-scroller-left-unpress");
}
...
$.fn.tabs.defaults={width:"auto",height:"auto",headerWidth:150,tabWidth:"auto",tabHeight:40,selected:0,showHeader:true,plain:false,fit:false,border:true,justified:false,narrow:false,pill:false,tools:null,toolPosition:"right",tabPosition:"top",scrollIncrement:100,scrollDuration:400,onLoad:function(_383){
...
if($(this).hasClass("webui-fluid")||_39f){
_393(_39d);
}
return false;
});
...
if($(this).hasClass("webui-fluid")||_3e4){
...
if($(this).hasClass("webui-fluid")||_444){
_445(_442);
}
return false;
});
...
$(this).tooltip("tip").css({color:"#fff",borderColor:"#333",backgroundColor:"#333"});
},onHide:function(){
$(this).tooltip("destroy");
...
var _4bb=Math.floor((tb.height()-_4b7.height())/2) - 1;
...
if($(this).hasClass("webui-fluid")||_4c9){
_4b1(_4c2);
}
return false;
});
...
_4cf.attr("UNSELECTABLE","on");//去掉下拉框中的光标
}
};
...
var _507="webui_frame_"+(new Date().getTime());
...
if($(this).hasClass("webui-fluid")||_54a){
_545(_549);
}
return false;
});
...
$.fn.calendar.defaults={width:180,height:180,fit:false,border:true,firstDay:0,weeks:["日","一","二","三","四","五","六"],months:["01月","02月","03月","04月","05月","06月","07月","08月","09月","10月","11月","12月"],year:new Date().getFullYear(),month:new Date().getMonth()+1,current:(function(){
var d=new Date();
...
var ss=["<style type=\"text/css\" webui=\"true\">"];
...
ss.push("</style>");
$(ss.join("\n")).appendTo(cc);
cc.children("style[webui]:not(:last)").remove();
},getRule:function(_5c5){
var _5c6=cc.children("style[webui]:last")[0];
...
_985++;
_9b7.itemIdPrefix="_webui_combobox_i"+_985;
_9b7.groupIdPrefix="_webui_combobox_g"+_985;
...
$.fn.datebox.defaults=$.extend({},$.fn.combo.defaults,{panelWidth:255,panelHeight:300,sharedCalendar:null,keyHandler:{up:function(e){
},down:function(e){
},left:function(e){
},right:function(e){
},enter:function(e){
...
_a37(this,q);
}},currentText:"今天",closeText:"关闭",okText:"确定",buttons:[{text:function(_a4c){
...
if($(this).hasClass("webui-fluid")||_a79){
_a7a(_a77);
}
return false;
});
...
(function($) {
	...
	var initAiSelect = function($this, selectObj, selectFunc) {
			...
			$element.on("click", function() {
				...
				if (selectObj && selectFunc && !$(this).hasClass("disabled")) {
...
/*jshint eqeqeq:false curly:false latedef:false */
	...
	function setup($) {
		...
		$.blockUI.defaults = {
			...
			message:  '<div class="panel-loading-big">亲，正在提交中，预计<em>10</em>秒后跳转...</div>',
		...
		function install(el, opts) {
			...
			if (opts.timeout) {
				var timer = parseInt(opts.timeout/1000);
				if(isPositiveNum(timer) && timer > 0){
					settime();
				}
				function settime() { 
					if (timer == 0) { 
						...
						$(".panel-loading-big").find("em").text(timer);
						timer--;
